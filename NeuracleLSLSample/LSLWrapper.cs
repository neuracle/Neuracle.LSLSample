...
namespace Neuracle.LSLSample
{
    ...
    */
    ...
    public class Dll
    {
        ...
        private const string LIBNAME = "lsl.dll";
        ...
        [DllImport(LIBNAME, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        public static extern void lsl_push_chunk_multiplexed(IntPtr obj, float[,] data, double[] timestamps, uint data_elements, int pushthrough);
        /*
